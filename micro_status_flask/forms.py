...
class DatasetForm(FlaskForm):
    ...
    keep_composites = RadioField("Keep Composites", choices=[(1, "Yes"), (0, "No")], coerce=int)
    delete_405 = RadioField("Delete 405", choices=[(1, "Yes"), (0, "No")], coerce=int)
    created = StringField("Created", validators=[Optional()])
    modality = StringField("Modality", validators=[Optional()])
    is_brain = RadioField("Is Brain", choices=[(1, "Yes"), (0, "No")], coerce=int)
    peace_json_created = RadioField("Peace JSON Created", choices=[(1, "Yes"), (0, "No")], coerce=int)
    imaging_summary = StringField("Imaging Summary", validators=[Optional()])
    moved = RadioField("Moved", choices=[(1, "Yes"), (0, "No")], coerce=int)
    moving = RadioField("Moving", choices=[(1, "Yes"), (0, "No")], coerce=int)
    paused = RadioField("Paused", choices=[(1, "Yes"), (0, "No")], coerce=int)
